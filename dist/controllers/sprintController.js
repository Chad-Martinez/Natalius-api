...
const addSprint = async (req, res, next) => {
    try {
        ...
        const { userId } = req;
        const startDate = (0, dayjs_1.default)(start).utc();
        const endDate = (0, dayjs_1.default)(startDate).add(2, 'week').utc();
...
const updateSprint = async (req, res, next) => {
    try {
        ...
        const startDate = dayjs_1.default.utc(start);
        const endDate = (0, dayjs_1.default)(startDate).add(2, 'week');
